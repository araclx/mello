...
export const MELLO_ENCRYPTION_KEY = process.env.MELLO_ENCRYPTION_KEY! || 'devisnotsecure'
...
export const MELLO_AUTH_SECRET = process.env.MELLO_AUTH_SECRET! || MELLO_ENCRYPTION_KEY
